...
class BMWDetailsPage extends StatefulWidget {
  const BMWDetailsPage({super.key});

  @override
  State<BMWDetailsPage> createState() => _DetailsPageState();
}

class _DetailsPageState extends State<BMWDetailsPage> {
  @override
  void initState() {
  ...
  showNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            title: "You booked to buy BMW car",
  ...
  showRentNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: 10,
            channelKey: 'basic_channel',
            title: "You booked to Rent BMW car",
