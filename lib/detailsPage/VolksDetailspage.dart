...
class VolksDetailsPage extends StatefulWidget {
  const VolksDetailsPage({super.key});

  @override
  State<VolksDetailsPage> createState() => _VolksDetailsPageState();
}

class _VolksDetailsPageState extends State<VolksDetailsPage> {
  @override
  void initState() {
  ...
  showNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            title: "You booked to buy Volkswagan car",
  ...
  showRentNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: 10,
            channelKey: 'basic_channel',
            title: "You booked to Rent Volkswagen car",
