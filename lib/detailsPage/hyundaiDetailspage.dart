...
class HyundaiDetailsPage extends StatefulWidget {
  const HyundaiDetailsPage({super.key});

  @override
  State<HyundaiDetailsPage> createState() => _HyundaiDetailsPageState();
}

class _HyundaiDetailsPageState extends State<HyundaiDetailsPage> {
  @override
  void initState() {
  ...
  showNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            title: "You booked to buy Hyundai car",
  ...
  showRentNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: 10,
            channelKey: 'basic_channel',
            title: "You booked to Rent Hyundai car",
