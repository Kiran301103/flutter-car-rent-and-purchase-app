...
class BenzDetailsPage extends StatefulWidget {
  const BenzDetailsPage({super.key});

  @override
  State<BenzDetailsPage> createState() => _BenzDetailPageState();
}

class _BenzDetailPageState extends State<BenzDetailsPage> {
  @override
  void initState() {
  ...
  showNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            title: "You booked to buy Benz car",
  ...
  showRentNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: 10,
            channelKey: 'basic_channel',
            title: "You booked to Rent Benz car",
