...
class AudiDetailsPage extends StatefulWidget {
  const AudiDetailsPage({super.key});

  @override
  State<AudiDetailsPage> createState() => _AudiStatePageState();
}

class _AudiStatePageState extends State<AudiDetailsPage> {
  @override
  void initState() {
  ...
  showBuyNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            title: "You booked to buy Audi car",
  ...
  showRentNotification() {
    AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: 10,
            channelKey: 'basic_channel',
            title: "You booked to Rent Audi car",
